...
$friend_fb_id = $_POST['friend_fb_id'];
  ...
  $sql = "SELECT * from fun_box where (my_fb_id ='$my_fb_id' or friend_fb_id='$my_fb_id ') and (my_fb_id ='$friend_fb_id' or friend_fb_id='$friend_fb_id')";
