...
$sql = "Select * from persons where fb_id not in (select sender_id from friends where recipient_id = '$my_fb_id' union select recipient_id from friends where sender_id = '$my_fb_id') and fb_id != '$my_fb_id' and name LIKE '%$name%'";
