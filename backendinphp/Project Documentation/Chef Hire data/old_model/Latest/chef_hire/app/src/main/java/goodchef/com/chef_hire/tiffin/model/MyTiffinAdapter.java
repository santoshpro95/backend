...
public class MyTiffinAdapter extends RecyclerView.Adapter<MyTiffinAdapter.MyViewHolder> {

    public List<MyTiffinAlbum> trackingAlbums;
    ...
    @Override
    public MyTiffinAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MyTiffinAdapter.MyViewHolder holder, int position) {

        final MyTiffinAlbum album = trackingAlbums.get(position);
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(mContext, MyTiffinDetails.class);
    ...
    public MyTiffinAdapter(Context mContext, List<MyTiffinAlbum> trackingAlbums) {
