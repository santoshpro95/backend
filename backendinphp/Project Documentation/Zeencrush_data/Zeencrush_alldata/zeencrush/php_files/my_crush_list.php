...
$my_fb_id=$_POST['my_fb_id'];
 ...
 // $sql = "select * from friends where recipient_id ='$my_fb_id'  ";
  ...
  $sql = "SELECT sender_name,sender_id,gender,birthday,alpha,lat,log,time,about,profession FROM persons p, friends f WHERE   p.fb_id = f.sender_id and f.recipient_id = '$my_fb_id' ";
