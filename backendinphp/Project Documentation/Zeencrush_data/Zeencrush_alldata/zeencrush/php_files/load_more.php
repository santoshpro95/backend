...
// $sql = "Select * from persons where fb_id not in (select recipient_id from friends where sender_id = '$my_fb_id') and fb_id != '$my_fb_id'";



$sql = "select * from persons where (id>'$id' and id<'$new_id') and fb_id != '$my_fb_id'  LIMIT 4 ";
